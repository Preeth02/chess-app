...
import { signUpSchema, singInSchema } from "schema/userAuthenticationSchema";
import { z } from "zod";
...
function page() {
  ...
  const onSubmit = async (userData: any) => {
    ...
    const { data, error } = await authClient.signIn.email(
      {
        email: identifier, // user email address
        ...
        <CardContent className="mt-4">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="px-4 py-2 rounded-lg my-3"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <Button
                type="submit"
                className="w-full py-2 text-base font-medium rounded-lg cursor-pointer"
              >
                Login
              </Button>
            </form>
